...
void LIBRARY::rentBook( std::shared_ptr<USER> user, const int isbn) {		// Vi sjekker om boka finnes,
...
void LIBRARY::reserveBook(std::shared_ptr<USER> user, const int isbn) {
...
void LIBRARY::returnBook(std::shared_ptr<USER> user, const int isbn)
{
	auto book = searchBook(isbn);
